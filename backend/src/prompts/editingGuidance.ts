...
- For calendar events, preserve the existing event and edit only the requested field(s) such as title, start time, end time, location, or description.
- For calendar follow-up commands, interpret "change the title", "move it", and similar phrases as edits to the active event when one is open.
`;
